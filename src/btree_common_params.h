#ifndef ROMZ_CPP_BTREE_BTREE_COMMON_PARAMS_H
#define ROMZ_CPP_BTREE_BTREE_COMMON_PARAMS_H
...
{
    //
    // If Compare is derived from btree_key_compare_to_tag then use it as the key_compare type.
    // Otherwise, use btree_key_compare_to_adapter<> which will
    ...
    //
    // A type which indicates if we have a key-compare-to functor or a plain old key-compare functor.
    //
